				...
				<div className="member_container">
					...
					<div className="d-flex justify-content-center">
						<table className="join_table">
							<tr>
								<th className="join_th">이름</th>
								<td className="join_td">
									<input type="text" className="join_form" />									{/* name값을 넣고, changeName이라는 Event를 발생시킨다. */}
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td className="join_td">
									<input type="password" className="join_form" />									{/* pwd값을 넣고, changePwd라는 Event를 발생시킨다. */}
								</td>
							</tr>
							<tr>
								<th className="join_th">비밀번호 확인</th>
								<td className="join_td">
									<input type="password" className="join_form" />						{/* checkPwd값을 넣고, changeCheckPwd라는 Event를 발생시킨다. */}
								</td>
							</tr>
							<tr>
								<th className="join_th">전화번호</th>
								<td className="join_td">
									<input type="text" className="join_form" />									{/* email값을 넣고, changeEmail이라는 Event를 발생시킨다. */}
								</td>
							</tr>
						</table><br />
					</div>
					<div className="d-flex justify-content-center">
						...
						<Button size={"default"} color={"blue"}text={"가입하기"}></Button>		{/* 값을 전부 입력하고 버튼을 누르면, join이라는 함수를 실행한다. */}
					</div>
				</div>

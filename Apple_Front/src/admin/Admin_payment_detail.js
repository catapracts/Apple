                            ...
                            <div>
                                <table className="payment_detail_table">
                                    <tr>
                                        ...
                                        <td className="payment_detail_td">회원 ID</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">이름</th>
                                        <td className="payment_detail_td">이름</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">연락처</th>
                                        <td className="payment_detail_td">연락처</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                            ...
                            <div>
                                <table className="payment_detail_table">
                                    ...
                                    <tr>
                                        ...
                                        <td className="payment_detail_td">우편번호</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">주소</th>
                                        <td className="payment_detail_td">주소</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                            ...
                            <div>
                                <table className="payment_detail_table">
                                    <tr>
                                        ...
                                        <td className="payment_detail_td">결제번호출력</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">기종</th>
                                        <td className="payment_detail_td">기종출력</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">HDD</th>
                                        <td className="payment_detail_td">HDD출력</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">색상</th>
                                        <td className="payment_detail_td">색상출력</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">가격</th>
                                        <td className="payment_detail_td">가격출력</td>
                                    </tr>
                            ...
                            <div>
                                <table className="payment_detail_table">
                                    ...
                                    <tr>
                                        ...
                                        <td className="payment_detail_td">카드사</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">카드번호</th>
                                        <td className="payment_detail_td">카드번호</td>
                                    </tr>
                                    <tr>
                                        <th className="payment_detail_th">결제일</th>
                                        <td className="payment_detail_td">결제일</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
